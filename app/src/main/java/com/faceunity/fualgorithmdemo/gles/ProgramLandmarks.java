 ...
 */
package com.faceunity.fualgorithmdemo.gles;

import android.hardware.Camera;
import android.opengl.GLES20;
import android.opengl.Matrix;

import com.faceunity.fualgorithmdemo.gles.core.Drawable2d;
import com.faceunity.fualgorithmdemo.gles.core.GlUtil;
import com.faceunity.fualgorithmdemo.gles.core.Program;
...
public class ProgramLandmarks extends Program {
    ...
    private static final float[] POINT_COLOR = {0f, 1.0f, 0f, 1.0f};
    private static final float[] DENSE_POINT_COLOR = {1.0f, 0f, 1.0f, 1.0f};
    private static final float POINT_SIZE = 6.0f;
    private static final float DENSE_POINT_SIZE = 4.0f;
    ...
    public void drawFrame(int textureId, float[] texMatrix, float[] mvpMatrix) {
        ...
        // Draw the triangle for first part
        GLES20.glDrawArrays(GLES20.GL_POINTS, 0, 75);

        //change color and size
        GLES20.glUniform4fv(mColorHandle, 1, DENSE_POINT_COLOR, 0);
        GLES20.glUniform1f(mPointSizeHandle, DENSE_POINT_SIZE);

        // Draw the triangle for the rest of points
        GLES20.glDrawArrays(GLES20.GL_POINTS, 75, 239 - 75);
