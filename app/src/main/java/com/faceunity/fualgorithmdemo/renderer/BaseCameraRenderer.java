package com.faceunity.fualgorithmdemo.renderer;
...
import com.faceunity.fualgorithmdemo.gles.ProgramLandmarks;
import com.faceunity.fualgorithmdemo.gles.ProgramTexture2d;
import com.faceunity.fualgorithmdemo.gles.ProgramTextureOES;
import com.faceunity.fualgorithmdemo.gles.core.GlUtil;
import com.faceunity.fualgorithmdemo.utils.FPSUtil;
...
public class BaseCameraRenderer implements GLSurfaceView.Renderer {
     ...
     * 显示 landmarks 点位开关
     */
    public static final boolean ENABLE_DRAW_LANDMARKS = true;
...
//            }
    ...
    public void setLandmarksDataArray(float[] landmarksDataArray) {
        mLandmarksData = landmarksDataArray;
    }
